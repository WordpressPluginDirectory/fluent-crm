...
use FluentCrm\Framework\Support\Env;
use FluentCrm\Framework\Http\Client;
use FluentCrm\Framework\Foundation\Config;
use FluentCrm\Framework\Container\Container;
use FluentCrm\Framework\Foundation\ComponentBinder;
use FluentCrm\Framework\Foundation\Concerns\FoundationTrait;
 ...
 *
 * @property \FluentCrm\Framework\Foundation\Config        $config
 * @property \FluentCrm\Framework\View\View                $view
 * @property \FluentCrm\Framework\Cache\Cache              $cache
 * @property \FluentCrm\Framework\Http\Router\Router       $router
 * @property \FluentCrm\Framework\Http\Request\Request     $request
 * @property \FluentCrm\Framework\Http\Response\Response   $response
 * @property \FluentCrm\Framework\Validator\Validator      $validator
 * @property \FluentCrm\Framework\Events\Dispatcher        $events
 * @property \FluentCrm\Framework\Encryption\Encrypter     $encrypter
 * @property \FluentCrm\Framework\Encryption\Encrypter     $crypt
 * @property \FluentCrm\Framework\Database\DatabaseManager $db
 * @property \FluentCrm\Framework\Http\URL                 $url
 * @property \FluentCrm\Framework\Support\Mail             $mail
 * @property \FluentCrm\Framework\Support\Pipeline         $pipeline
...
class Application extends Container
{
     ...
     * 
     * @param \FluentCrm\Framework\Http\Router $router
     * 
     * @return void
     */
