...
use FluentCrm\Framework\Support\UrlRoutable;
use FluentCrm\Framework\Support\JsonableInterface;
use FluentCrm\Framework\Support\ArrayableInterface;
use FluentCrm\Framework\Support\HelperFunctionsTrait;
use FluentCrm\Framework\Support\CanBeEscapedWhenCastToString;
use FluentCrm\Framework\Support\Collection as BaseCollection;
use FluentCrm\Framework\Database\Schema;
use FluentCrm\Framework\Database\Orm\Relations\Pivot;
use FluentCrm\Framework\Database\Orm\Relations\BelongsToMany;
use FluentCrm\Framework\Database\Orm\Relations\HasManyThrough;
use FluentCrm\Framework\Database\Orm\Relations\Concerns\AsPivot;
use FluentCrm\Framework\Database\Orm\Collection as OrmCollection;
use FluentCrm\Framework\Database\ConnectionResolverInterface as Resolver;
 ...
 *
 * @mixin \FluentCrm\Framework\Database\Orm\Builder
 */
abstract class Model implements ArrayableInterface, ArrayAccess, CanBeEscapedWhenCastToString, JsonableInterface, JsonSerializable, UrlRoutable
{
     ...
     *
     * @var \FluentCrm\Framework\Database\ConnectionResolverInterface
     */
     ...
     * @return $this
     *
     * @throws \FluentCrm\Framework\Database\Orm\MassAssignmentException
     */
     ...
     * @return \FluentCrm\Framework\Database\Orm\Collection|static[]
     */
     ...
     *
     * @param  \FluentCrm\Framework\Support\Collection|array|int|string  $ids
     * @return int
     */
     ...
     *
     * @return \FluentCrm\Framework\Database\Orm\Builder|static
     */
     ...
     *
     * @param  \FluentCrm\Framework\Database\Orm\Scope|string  $scope
     * @return \FluentCrm\Framework\Database\Orm\Builder
     */
     ...
     * @return \FluentCrm\Framework\Database\Orm\Relations\Pivot
     */
     ...
     * @return string
     *
     * @throws \FluentCrm\Framework\Database\Orm\JsonEncodingException
     */
     ...
     *
     * @param  \FluentCrm\Framework\Database\Orm\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \FluentCrm\Framework\Database\ConnectionResolverInterface
     */
     ...
     *
     * @param  \FluentCrm\Framework\Database\ConnectionResolverInterface  $resolver
     * @return void
     */
     ...
     * @return \FluentCrm\Framework\Database\Orm\Model|null
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param  \FluentCrm\Framework\Database\Orm\Model  $query
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \FluentCrm\Framework\Database\Orm\Builder
     */
