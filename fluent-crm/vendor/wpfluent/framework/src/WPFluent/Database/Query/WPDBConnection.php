...
use FluentCrm\Framework\Database\Schema;
use FluentCrm\Framework\Database\QueryException;
use FluentCrm\Framework\Database\ConnectionInterface;
use FluentCrm\Framework\Database\MultipleColumnsSelectedException;
use FluentCrm\Framework\Database\Events\QueryExecuted;
use FluentCrm\Framework\Database\Query\Expression;
use FluentCrm\Framework\Database\Query\Processors\Processor;
use FluentCrm\Framework\Database\Query\Processors\MySqlProcessor;
use FluentCrm\Framework\Database\Query\Processors\SQLiteProcessor;
use FluentCrm\Framework\Database\Query\Builder as QueryBuilder;
use FluentCrm\Framework\Database\Query\Grammars\Grammar;
use FluentCrm\Framework\Database\Query\Grammars\MySqlGrammar;
use FluentCrm\Framework\Database\Query\Grammars\SQLiteGrammar;
use FluentCrm\Framework\Database\Concerns\ManagesTransactions;
use FluentCrm\Framework\Database\DetectsLostConnections;

use FluentCrm\Framework\Database\Events\TransactionBeginning;
use FluentCrm\Framework\Database\Events\TransactionCommitted;
use FluentCrm\Framework\Database\Events\TransactionCommitting;
use FluentCrm\Framework\Database\Events\TransactionRolledBack;
...
class WPDBConnection implements ConnectionInterface
{
     ...
     *
     * @var \FluentCrm\Framework\Database\DatabaseTransactionsManager|null
     */
     ...
     *
     * @var \FluentCrm\Framework\Events\Dispatcher
     */
     ...
     * @return mixed
     *
     * @throws \FluentCrm\Framework\Database\MultipleColumnsSelectedException
     */
     ...
     *
     * @param \FluentCrm\Framework\Database\Query\Grammars\Grammar $grammar
     * @return $this
     */
     ...
     *
     * @param \FluentCrm\Framework\Database\Query\Processors\Processor $processor
     * @return $this
     */
