...
class TransStrings
{
    public static function getStrings()
    {
        return [
            ...
            'Activate Fluent Toolkit' => __('Activate Fluent Toolkit', 'fluent-crm'),
            ...
            'AdvFeat_Multi_Archive_Shortcode_Help' => __('You can use multiple email campaign archives with the following shortcode: [fluent_crm_campaign_archives ids=1101,5,1100,1072 status=all search=Summer limit=50]. Each parameter can be used on its own; any parameter you leave out falls back to the global campaign archive settings.', 'fluent-crm'),
            ...
            'Create Coupon' => __('Create Coupon', 'fluent-crm'),
            'Create Custom Segment' => __('Create Custom Segment', 'fluent-crm'),
            'Create Email Template' => __('Create Email Template', 'fluent-crm'),
            'Create FluentCart Coupon Code' => __('Create FluentCart Coupon Code', 'fluent-crm'),
            ...
            'Dismiss' => __('Dismiss', 'fluent-crm'),
            'Database update required' => __('Database update required', 'fluent-crm'),
            'Database update complete' => __('Database update complete', 'fluent-crm'),
            'Message Database Update' => __('Message Database Update', 'fluent-crm'),
            'Message database is up to date.' => __('Message database is up to date.', 'fluent-crm'),
            'Move legacy SMS and WhatsApp messages into the conversation format used by the inbox.' => __('Move legacy SMS and WhatsApp messages into the conversation format used by the inbox.', 'fluent-crm'),
            'Update database' => __('Update database', 'fluent-crm'),
            'Updating...' => __('Updating...', 'fluent-crm'),
            '%s messages need updating to the new format. They will not appear in your inbox until this finishes.' => __('%s messages need updating to the new format. They will not appear in your inbox until this finishes.', 'fluent-crm'),
            '%s of %s messages updated' => __('%s of %s messages updated', 'fluent-crm'),
            '%s messages were updated and are now in your inbox.' => __('%s messages were updated and are now in your inbox.', 'fluent-crm'),
            ...
            'Download Sample JSON' => __('Download Sample JSON', 'fluent-crm'),
            ...
            'Enable Message Module' => __('Enable Message Module', 'fluent-crm'),
            ...
            'Fluent Toolkit' => __('Fluent Toolkit', 'fluent-crm'),
            'Fluent Toolkit %s' => __('Fluent Toolkit %s', 'fluent-crm'),
            'Fluent Toolkit %s (bundled adapter)' => __('Fluent Toolkit %s (bundled adapter)', 'fluent-crm'),
            'Fluent Toolkit (bundled adapter)' => __('Fluent Toolkit (bundled adapter)', 'fluent-crm'),
            'Fluent Toolkit is active, but this version does not include the bundled MCP adapter yet. Update Fluent Toolkit when the MCP-ready build is available.' => __('Fluent Toolkit is active, but this version does not include the bundled MCP adapter yet. Update Fluent Toolkit when the MCP-ready build is available.', 'fluent-crm'),
            'Fluent Toolkit is installed but not active. Activate it to use the bundled MCP adapter.' => __('Fluent Toolkit is installed but not active. Activate it to use the bundled MCP adapter.', 'fluent-crm'),
            ...
            'FluentCRM ships AI agent tools, but they only become available once Fluent Toolkit is installed and active.' => __('FluentCRM ships AI agent tools, but they only become available once Fluent Toolkit is installed and active.', 'fluent-crm'),
            ...
            'FluentCRM ships AI agent tools, but they only become available once an MCP adapter is installed and active. FluentCampaign Pro can install Fluent Toolkit, which includes the bundled adapter.' => __('FluentCRM ships AI agent tools, but they only become available once an MCP adapter is installed and active. FluentCampaign Pro can install Fluent Toolkit, which includes the bundled adapter.', 'fluent-crm'),
            ...
            'Get Fluent Toolkit' => __('Get Fluent Toolkit', 'fluent-crm'),
            'Get Fluent Toolkit from GitHub' => __('Get Fluent Toolkit from GitHub', 'fluent-crm'),
            ...
            'Importing Contacts' => __('Importing Contacts', 'fluent-crm'),
            ...
            'Install Fluent Toolkit' => __('Install Fluent Toolkit', 'fluent-crm'),
            ...
            'Max Campaigns to list (max 200)' => __('Max Campaigns to list (max 200)', 'fluent-crm'),
            ...
            'Message Module' => __('Message Module', 'fluent-crm'),
            'Message Module Settings' => __('Message Module Settings', 'fluent-crm'),
            'Message_Module_Help' => __('Reach contacts on SMS and WhatsApp from Campaigns, Automations and a shared Inbox.', 'fluent-crm'),
            'Message_Module_Note' => __('Once enabled, turn on SMS or WhatsApp individually from Settings > Messaging.', 'fluent-crm'),
            ...
            'Messaging' => __('Messaging', 'fluent-crm'),
            ...
            'Open Fluent Toolkit MCP settings' => __('Open Fluent Toolkit MCP settings', 'fluent-crm'),
            ...
            'Please select an existing coupon code' => __('Please select an existing coupon code', 'fluent-crm'),
            ...
            'Settings could not be loaded. Please reload the page and try again.' => __('Settings could not be loaded. Please reload the page and try again.', 'fluent-crm'),
            ...
            'Update Fluent Toolkit' => __('Update Fluent Toolkit', 'fluent-crm'),
